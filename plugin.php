...
class WP_Swift_Linked_In_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'wp-swift-linked-in-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'WP Swift: Linked In Widget', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'A WordPress widget for displaying a linked in profile.', $this->get_widget_slug() )
			)
		);
	...
	public function widget_textdomain() {
		...
		// TODO be sure to change 'wp-swift-linked-in-widget' to the name of *your* plugin
...
// TODO: Remember to change 'WP_Swift_Linked_In_Widget' to match the class name definition
add_action( 'widgets_init', create_function( '', 'register_widget("WP_Swift_Linked_In_Widget");' ) );

// Hooks fired when the Widget is activated and deactivated
// register_activation_hook( __FILE__, array( 'WP_Swift_Linked_In_Widget', 'activate' ) );
